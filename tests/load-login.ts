...
export const options = {
    ...
    stages: [
      { duration: '1m', target: 500 }, // just slowly ramp-up to a HUGE load
    ...
    thresholds: {
      ...
      http_req_duration: [{ threshold: 'p(95)<1000', abortOnFail: true, delayAbortEval: "1s" }], // 95% of requests should be below 1s
    },
  };
